...
HACSObj <- HACHypothetical(N = N, Hstar = Hstar, probs = probs, perms = 10000, p = 0.95, conf.level = 0.95, filename = "output")

## Simulate hypothetical species - subsampling ##
HACSObj <- HACHypothetical(N = N, Hstar = Hstar, probs = probs, perms = 10000, p = 0.95, subsample = TRUE, prop = 0.25, conf.level = 0.95, filename = "output")
...
HACSObj <- HACReal(p = 0.90, perms = 10000, conf.level = 0.95, filename = "Boloria freija")
