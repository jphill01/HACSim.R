...
In addition to users specifying unique values for N, Hstar and probs, default parameters can also be altered in order to produce more interesting output. perms can be increased to smooth out curves, but this will increase algorithm runtime substantially.  
