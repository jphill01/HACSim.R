...
HACSim (**H**aplotype **A**ccumulation **Sim**ulator) is a novel algorithm written in R for the simulation of haplotype accumulation curves. It can be employed to determine required sample sizes for DNA barcoding, specifically as pertaining to recovery of total haplotype variation that may exist for a given species.
