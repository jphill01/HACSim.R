...
The present algorithm randomly samples species haplotype labels repeatedly in an iterative fashion, the idea being that levels of species haplotypic variation that are currently catalogued in pubic genomic databases such as BOLD can serve as proxies for total haplotype diversity that may exist for a given species.
